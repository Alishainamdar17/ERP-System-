...
getValue: (w) => {
  ...
  return val === "" || val === undefined ? null : val;
    ...
    doc.text("Building No/Flat No 327, Bopgaon Chowk", 160, 25, { align: "center" });
    doc.setFontSize(8);
    doc.setTextColor(100, 100, 100);
    doc.text("Nearby Lanmark:Bhopgaon Bus Stand", 160, 25, { align: "center" });
    doc.setFontSize(8);
    doc.setTextColor(100, 100, 100);
    doc.text("Locality/Sub Locality: Bhopgaon", 160, 25, { align: "center" });
    doc.setFontSize(8);
    doc.setTextColor(100, 100, 100);
    doc.text("City/Town/Village: Purandhar Fort", 160, 25, { align: "center" });
    doc.setFontSize(8);
    doc.setTextColor(100, 100, 100);
    doc.text("Pune,Maharashtra 412301", 160, 25, { align: "center" });
    doc.setFontSize(8);
    doc.setTextColor(100, 100, 100);
    doc.text("Tel.No :- 9011333735", 160, 25, { align: "center" });
    doc.setFontSize(8);
    doc.setTextColor(100, 100, 100);
    doc.text("E-Mail :- info@onedlfs.com", 160, 25, { align: "center" });
    ...
    doc.text('Cont No: ' + (refTrip.driverContact || "N/A"), 220, 66);
